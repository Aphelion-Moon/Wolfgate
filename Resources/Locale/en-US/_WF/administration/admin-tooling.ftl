...
wf-spawn-outfit-search = Search outfits...
...
cmd-spawnoutfit-help = Usage: {$command} <target entity> <starting gear ID> [take control: true/false]
...
cmd-spawnoutfit-invalid-args = Expected two or three arguments.
