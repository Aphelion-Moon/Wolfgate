...
Run from the repository root:  python Tools/_WF/WolfgateLogo/generate_icons.py
Requires Pillow. Writes icon/icon-NxN.png for every size the client loads plus icon.ico into
Resources/Textures/_WF/Logo. logo.png (splash and main menu) is hand-made and not touched.
"""
import os
...
OUT = os.path.join(ROOT, "Resources", "Textures", "_WF", "Logo")
