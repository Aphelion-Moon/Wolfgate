...
namespace Content.Client.Launcher
{
    ...
    public sealed partial class LauncherConnectingGui : Control
    {
        ...
        // A whitelist refusal can carry a Discord link URL; the buttons below the reason open or copy it.
            ...
            IPrototypeManager prototype, IConfigurationManager config, IClipboardManager clipboard)
        {
            ...
            SymphonyLinkButton.OnPressed += _ =>
            {
                if (_symphonyLink != null)
                    IoCManager.Resolve<IUriOpener>().OpenUri(_symphonyLink);
            };
            SymphonyCopyLinkButton.OnPressed += _ => CopyText(_symphonyLink);
        ...
        private void HandleDisconnectReason(INetStructuredReason? reason)
        {
            ...
            else
            {
                ...
                // Only an http(s) URL gets a button; anything else the server sent is shown as text alone.
            ...
            SymphonyLinkRow.Visible = _symphonyLink != null;
        }
